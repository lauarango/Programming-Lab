...
void destaparAlrrededores (int i, int j, tipocasilla** matriz,int filas,int columnas){ //Función para abrir las casillas laterales cuando la casilla que se escribe no tiene minas alrededor.
...
int evaluar(int filas,int columnas,tipocasilla** matriz,int num,struct timeval ti,struct timeval tf,int juefi,int jueco){ //Función que evalúa si se ganó
	double tiempo;
