...
int main (){
	...
	do {
		...
		if (numero== (NumMaquina*NumMaquina2)){
			...
			printf("Es mayor que el primer número mágico\n");
		}
		else if (numero > NumMaquina2){
		 	printf("Es mayor que el segundo número mágico\n");
		}
		else if (numero < NumMaquina){
			printf("Es menor que el primer número mágico\n");
		}
		else if (numero < NumMaquina2){
			printf("Es menor que el segundo número mágico\n");
		}


	}
	while ((numero != NumMaquina) && (numero != NumMaquina2) && (numero != (NumMaquina+NumMaquina2)) && (numero != (NumMaquina - NumMaquina2)) && (numero != (NumMaquina*NumMaquina2))&&(intentos<10));
	printf("U made it\n");
